...
@WebServlet("/SearchAccountantForm")
public class SearchAccountantForm extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session==null||session.getAttribute("admin")==null){
			...
			request.getRequestDispatcher("SearchAccountantForm.jsp").include(request, response);
